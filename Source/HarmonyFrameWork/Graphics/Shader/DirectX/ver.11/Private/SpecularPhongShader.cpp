...
#include "..\Public\SpecularPhongShader.h"
...
/**********************************************************************************************//**
																								* @fn	SpecularPhongShader::SpecularPhongShader(const SpecularPhongShader& other)
																								*
...
SpecularPhongShader::SpecularPhongShader(const SpecularPhongShader& other)
{
	m_graphicsPriority = HF_FORWARD_RENDERING_SHADER;
}

/**********************************************************************************************//**
																								* @fn	SpecularPhongShader::~SpecularPhongShader()
																								*
																								* @brief	Destructor.
																								*
																								* @author	Kazuyuki Honda
...
/**********************************************************************************************//**
																								* @fn	bool SpecularPhongShader::Init()
																								*
...
bool SpecularPhongShader::Setup()
{
	...
	res = sRENDER_DEVICE_MANAGER->CreateVertexShaderFromFile(
		m_cpVertexShader,
		"Resource/Shader/HLSL/SpecularPhongShader.hlsl",
		"VS_Main",
		"vs_5_0",
	...
	res = sRENDER_DEVICE_MANAGER->CreatePixelShaderFromFile(m_cpPixelShader, m_cpPSClassLinkage,
		_T("Resource/Shader/HLSL/SpecularPhongShader.hlsl"),
		"PS_Main",
		"ps_5_0", false);
...
/**********************************************************************************************//**
																								* @fn	void SpecularPhongShader::Destroy()
																								*
...
void SpecularPhongShader::Destroy()
{
}
...
/**********************************************************************************************//**
																								* @fn	bool SpecularPhongShader::Render()
																								*
...
bool SpecularPhongShader::Render()
{
	bool result = E_FAIL;
...
bool SpecularPhongShader::PostProcessOfRender()
{
...
/**********************************************************************************************//**
																								* @fn	bool SpecularPhongShader::PreRenderProcess ( std::shared_ptr<CBaseObject> spPram )
																								*
...
bool SpecularPhongShader::PreProcessOfRender(std::shared_ptr<SubMesh> mesh, std::shared_ptr<Material>materials)
{
...
void SpecularPhongShader::CreateAndRegisterGraphicsCommand(std::shared_ptr<BaseRenderMeshObject> renderObject, UINT element)
{
