	...
	HFVECTOR3 lightDirection)
{
	...
	sRENDER_DEVICE_MANAGER->GetImmediateContext()->PSSetShaderResources(6, 1, sRENDER_DEVICE_MANAGER->GetGeometryBuffer()->GetShaderResourceView(6)->GetSharderResorceView().GetAddressOf());
