#include "..\Public\ForwardDiffuseOnlyMeshShader.h"
...
FowardDiffuseOnlyMeshShader::FowardDiffuseOnlyMeshShader()
{
}
...
{		
	...
	res = sRENDER_DEVICE_MANAGER->CreateVertexShaderFromFile(
		m_cpVertexShader,
		"Resource/Shader/HLSL/FowardDiffuseMeshShader.hlsl",
		"VS_Main",
		"vs_5_0",
	...
	res = sRENDER_DEVICE_MANAGER->CreatePixelShaderFromFile(m_cpPixelShader, m_cpPSClassLinkage,
		_T("Resource/Shader/HLSL/FowardDiffuseMeshShader.hlsl"),
		"PS_Main",
		"ps_5_0", false);
...
void FowardDiffuseOnlyMeshShader::Destroy()
{

}

bool FowardDiffuseOnlyMeshShader::PreProcessOfRender(std::shared_ptr<SubMesh> mesh, std::shared_ptr<Material>materials)
{
	bool result;
...
bool FowardDiffuseOnlyMeshShader::Render()
{
	bool result = false;
...
bool FowardDiffuseOnlyMeshShader::PostProcessOfRender()
{
	return true;
}
