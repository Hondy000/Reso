...
#include <fstream>
#include "../../../../Public/Renderer/DirectX/ver.11/DirectX11RenderDeviceManager.h"
#include "../../../../Public/Renderer/DirectX/ver.11/GeometryBuffers.h"
#include "../../../../Public/Buffer/VertexBuffer.h"
#include "../../../../Public/Buffer/IndexBuffer.h"
#include "../../../../Public/Buffer/ConstantBuffer.h"
...
HFRESULT DirectX11RenderDeviceManager::Setup(void)
{
	HRESULT hr = S_OK;

	// メモリ確保
	m_spAdapter = std::shared_ptr<CDirectX11Adapter>(new CDirectX11Adapter);
	m_spSwapChain = std::shared_ptr<CDirectX11SwapChain>(new CDirectX11SwapChain);
	...
	m_displayMode.Width = 1024;
	m_displayMode.Height = 768;
	...
	//CopyMemory(&m_displayMode, &m_DisplayModeDesc[0], sizeof(DXGI_MODE_DESC));
...
HRESULT DirectX11RenderDeviceManager::InitD3D11(
	...
	)
{
	...
	// スワップチェーンの作成
	hr = m_spSwapChain->CreateSwapChain(pDisplayMode, MultisampleEnabled);
	if (FAILED(hr)) goto EXIT;
...
void DirectX11RenderDeviceManager::Clear(void)
{
	HRESULT hr = E_FAIL;
	...
	if (m_spDeferredBuffer)
	{
		...
		m_spDeferredBuffer->ClearRenderTargets(GetImmediateContext(), 0.3f, 0.3f, 0.8f, 1.0f);
	}
...
/**********************************************************************************************//**
 * @fn	HFRESULT CDirectX11RenderDeviceManager::SetUpDeferredRenderer()
 *
 ...
 **************************************************************************************************/
 /*
HFRESULT CDirectX11RenderDeviceManager::SetUpDeferredRenderer()
{
...
HRESULT DirectX11RenderDeviceManager::GetDisplayMode()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateDevice(BOOL DirectX11Only)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateRenderTargetView()
{
	HRESULT hr = E_FAIL;
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateDepthStencilView()
 *
 * @brief	深度ステンシルビューの作成.
 *
 * @author	Kazuyuki Honda
...
HRESULT DirectX11RenderDeviceManager::CreateDepthStencilView()
{
	HRESULT hr = E_FAIL;
	Microsoft::WRL::ComPtr<ID3D11Texture2D> pBackBuffer = NULL;
...
HRESULT DirectX11RenderDeviceManager::CreateViewport()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::SetWindowAssociation()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::SetDefaultRasterize()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::SetDefaultDepthStencilState()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::ChangeWindowModeOptimization(UINT Width, UINT Height)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::ChangeWindowMode()
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateBuffer(
...
HRESULT DirectX11RenderDeviceManager::CreateVertexBuffer(
	Microsoft::WRL::ComPtr< ID3D11Buffer>& pBuffer,
	void* pData,
	size_t size,
	UINT CPUAccessFlag
...
HRESULT DirectX11RenderDeviceManager::CreateIndexBuffer(
	Microsoft::WRL::ComPtr<ID3D11Buffer>& pBuffer,
	void* pData,
	size_t size,
	UINT CPUAccessFlag
...
HRESULT DirectX11RenderDeviceManager::CreateConstantBuffer(
	Microsoft::WRL::ComPtr<ID3D11Buffer>& pBuffer,
	void* pData,
	size_t size,
	UINT CPUAccessFlag
...
HRESULT DirectX11RenderDeviceManager::CreateShaderResourceViewArray(
	...
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& pSRVView)
{
	...
	for (UINT i = 0; i < NumTextures; i++)
	{
		...
		hr = D3DX11CreateTextureFromFile(m_cpD3DDevice.Get(), pTextureFileNames[i].c_str(), &info, NULL, pLoadedRes.GetAddressOf(), NULL);
		if (FAILED(hr))
		{
			return hr;
		}
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateVertexShaderFromFile(OUT ID3D11VertexShader** pVertexShader, IN TCHAR pSrcFile[], IN CHAR pFunctionName[], IN CHAR pProfile[], OUT ID3D11InputLayout** g_pLayout, IN D3D11_INPUT_ELEMENT_DESC pLayoutDesc[], UINT NumElements)
 *
...
HRESULT DirectX11RenderDeviceManager::CreateVertexShaderFromFile(OUT Microsoft::WRL::ComPtr< ID3D11VertexShader>& cpVertexShader,
	...
	IN D3D11_INPUT_ELEMENT_DESC pLayoutDesc[], UINT NumElements)
{
	...
	hr = m_cpD3DDevice->CreateVertexShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), NULL, cpVertexShader.GetAddressOf());
	if (FAILED(hr))
	{
		return hr;
	}
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateVertexShaderFromMemory(ID3D11VertexShader** pVertexShader, const BYTE* pShader, size_t size, OUT ID3D11InputLayout** g_pLayout, IN D3D11_INPUT_ELEMENT_DESC pLayoutDesc[], UINT NumElements)
 *
...
HRESULT DirectX11RenderDeviceManager::CreateVertexShaderFromMemory(Microsoft::WRL::ComPtr< ID3D11VertexShader>& cpVertexShader,
...
HRESULT DirectX11RenderDeviceManager::CreateHullShaderFromFile(ID3D11HullShader** pHullShader,
	TCHAR pSrcFile[],
	CHAR pFunctionName[],
	CHAR pProfile[])
{
...
HRESULT DirectX11RenderDeviceManager::CreateHullShaderFromMemory(ID3D11HullShader** pHullShader, const BYTE* pShader, size_t size)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateDomainShaderFromFile(ID3D11DomainShader** pDomainShader,
	TCHAR pSrcFile[],
	CHAR pFunctionName[],
	CHAR pProfile[])
{
...
HRESULT DirectX11RenderDeviceManager::CreateDomainShaderFromMemory(ID3D11DomainShader** pDomainShader, const BYTE* pShader, size_t size)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateGeometryShaderFromFile(ID3D11GeometryShader** pGeometryShader,
	TCHAR pSrcFile[],
	CHAR pFunctionName[],
	CHAR pProfile[])
{
...
HRESULT DirectX11RenderDeviceManager::CreateGeometryShaderFromMemory(ID3D11GeometryShader** pGeometryShader, const BYTE* pShader, size_t size)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateGeometryShaderWithStreamOutputFromFile(
...
HRESULT DirectX11RenderDeviceManager::CreateGeometryShaderWithStreamOutputFromMemory(
	ID3D11GeometryShader** pGeometryShader,
	const BYTE* pShader, size_t size,
	const D3D11_SO_DECLARATION_ENTRY *pSODeclaration,
	UINT NumEntries,
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreatePixelShaderFromFile(ID3D11PixelShader** pPixelShader, TCHAR pSrcFile[], CHAR pFunctionName[], CHAR pProfile[] )
 *
...
HRESULT DirectX11RenderDeviceManager::CreatePixelShaderFromFile(Microsoft::WRL::ComPtr<ID3D11PixelShader>& pPixelShader,
	TCHAR pSrcFile[],
	CHAR  pFunctionName[],
	CHAR  pProfile[]
	)
{
	...
	// ファイルを元にエフェクトをコンパイルする
	// D3DX11CompileFromFile
	hr = D3DX11CompileFromFile(LPCSTR(pSrcFile), NULL, NULL, pFunctionName, Profile, Flag1, 0, NULL, pBlob.GetAddressOf(), cpErrorMessage.GetAddressOf(), NULL);
	if (FAILED(hr))
	{
		const TCHAR* text;// = (hr);
		OutputShaderErrorMessage(cpErrorMessage, pSrcFile);
	...
	hr = m_cpD3DDevice->CreatePixelShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), NULL, pPixelShader.GetAddressOf());
	if (FAILED(hr))
	{
		return hr;
	}
...
HFRESULT DirectX11RenderDeviceManager::SetupDeferredBuffer()
{
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreatePixelShaderFromMemory(ID3D11PixelShader** pPixelShader, const BYTE* pShader, size_t size)
 *
...
HRESULT DirectX11RenderDeviceManager::CreatePixelShaderFromMemory(Microsoft::WRL::ComPtr<ID3D11PixelShader>& pPixelShader, const BYTE* pShader, size_t size)
{
	HRESULT hr = E_FAIL;
...
HRESULT DirectX11RenderDeviceManager::CreateScreenShot()
{
	HRESULT hr = E_FAIL;
	...
	m_spSwapChain->GetCpSwapChain()->GetDesc(&swapchainDesc);
	...
	if (swapchainDesc.SampleDesc.Count == 1 && swapchainDesc.SampleDesc.Quality == 0)
	{
		...
		hr = D3DX11SaveTextureToFile(m_cpImmediateContext.Get(), pBackBuffer, D3DX11_IFF_JPG, path);
		if (FAILED(hr)) goto EXIT;
	}
	...
	else
	{
		...
		// コピー先用のテクスチャーを作成する。
		hr = m_cpD3DDevice->CreateTexture2D(&texDesc, NULL, &pTexture);
		if (FAILED(hr)) goto EXIT;

		// マルチサンプリングされたリソースをマルチサンプリングされていないリソースにコピーする
		// ID3D11DeviceContext::ResolveSubresource
		m_cpImmediateContext->ResolveSubresource(pTexture, NULL, pBackBuffer, NULL, texDesc.Format);

		// ファイル出力
		hr = D3DX11SaveTextureToFile(m_cpImmediateContext.Get(), pTexture, D3DX11_IFF_JPG, path);
		if (FAILED(hr)) goto EXIT;
	}
...
HRESULT DirectX11RenderDeviceManager::SetBlendState(D3D11_RENDER_TARGET_BLEND_DESC BlendStateArray[], UINT NumBlendState, BOOL AlphaToCoverageEnable)
{
	HRESULT hr = E_FAIL;
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateSamplerState(ID3D11SamplerState** ppSamplerState, D3D11_FILTER Filter, UINT MaxAnisotropy)
 *
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::SetDepthStencilState(BOOL DepthEnable, D3D11_DEPTH_WRITE_MASK DepthWriteEnabled)
 *
...
HRESULT DirectX11RenderDeviceManager::SetDepthStencilState(BOOL DepthEnable, D3D11_DEPTH_WRITE_MASK DepthWriteEnabled)
{
	HRESULT hr = E_FAIL;
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateRenderTargetView(ID3D11RenderTargetView** ppRTView, D3DXVECTOR2* pRTViewSize, DXGI_FORMAT Format)
 *
...
HRESULT DirectX11RenderDeviceManager::CreateRenderTargetView(Microsoft::WRL::ComPtr<ID3D11RenderTargetView>& ppRTView, D3DXVECTOR2* pRTViewSize, DXGI_FORMAT Format)
{
	HRESULT hr;
...
/**********************************************************************************************//**
 * @fn	HRESULT CDirectX11RenderDeviceManager::CreateRenderTargetView(ID3D11RenderTargetView** ppRTView, D3DXVECTOR2* pRTViewSize, DXGI_FORMAT Format, UINT MipLevels)
 *
 * @brief	シェーダーにバインド可能なレンダーターゲットビューを作成する.
 *
 * @author	Kazuyuki Honda
...
HRESULT DirectX11RenderDeviceManager::CreateRenderTargetView(Microsoft::WRL::ComPtr<ID3D11RenderTargetView>& ppRTView, D3DXVECTOR2* pRTViewSize, DXGI_FORMAT Format, UINT MipLevels)
{
	HRESULT hr = E_FAIL;
